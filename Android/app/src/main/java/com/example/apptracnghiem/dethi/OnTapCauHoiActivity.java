...
public class OnTapCauHoiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDatabase = new MyDatabase(OnTapCauHoiActivity.this, "csdl_dethi.sqlite", null, 1);
        ...
        imgBackMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(OnTapCauHoiActivity.this, MainActivity.class);
